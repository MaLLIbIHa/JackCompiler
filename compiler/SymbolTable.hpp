...
public:
    ...
    ClassSymbol(std::string name,
                ...
                unsigned linePos,
                unsigned inLinePos)
               : SymbolNode(name, linePos, inLinePos),
...
public:
    ...
    SubroutineSymbol(std::string name,
                      Type* retT,
                      std::vector<Type*> args,
                      SubroutineKind sType,
                      unsigned linePos,
                      unsigned inLinePos
                     )
                     : SymbolNode(name, linePos, inLinePos),
                       retType_(retT),
                       argsTypes_(std::move(args)),
                       sType_(sType)
                       {}

    SymbolType getSymbolType() const override { return SymbolType::SUBROUTINE_SYM; }
...
public:
    ...
    SymbolType getSymbolType() const override { return SymbolType::LOCAL_VARIABLE_SYM; }
};

class ArgumentVariableSymbol final : public VarSymbol {
public:

    SymbolType getSymbolType() const override { return SymbolType::ARGUMENT_VARIABLE_SYM; }
};

class FieldVariableSymbol final : public VarSymbol {
public:
    FieldVariableSymbol(std::string name,
                         Type* vType,
    ...
    SymbolType getSymbolType() const override { return SymbolType::FIELD_VARIABLE_SYM; }
...
public:
    StaticVariableSymbol(std::string name,
                         Type* vType,
                         ClassSymbol* parentClass,
                         unsigned linePos,
                         unsigned inLinePos
    ...
    SymbolType getSymbolType() const override { return SymbolType::STATIC_VARIABLE_SYM; }
